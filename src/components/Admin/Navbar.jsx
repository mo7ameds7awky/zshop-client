...
import FlexBetween from "../General/FlexBetween.jsx";
import {
...
import {setMode} from "../../store/slices/global.js";
        ...
        <AppBar sx={{position: "static", background: "none", boxShadow: "none"}}>
            <Toolbar sx={{justifyContent: "space-between"}}>
                <FlexBetween>
                    ...
                    <FlexBetween backgroundColor={theme.palette.background.alt} borderRadius="9px" gap="3rem"
                                 p={"0.1rem 1.5rem"}>
